...
# -- Proprietary modules -- #
from UNET_functions import get_maxpool_layer, get_activation, get_conv_layer, get_normalization, conv_transpose_layer, Concatenate, get_up_layer
...
class UpBlock(nn.Module):
    ...
    def forward(self, encoder_layer, decoder_layer):
        ...
        # cropped_encoder_layer, dec_layer = encoder_layer, up_layer
